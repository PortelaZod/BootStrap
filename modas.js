...
let itens = document.querySelectorAll('.itemPlaceholder')

let a = document.querySelector('.btn_tam')
a.addEventListener('click',danone)

function danone(){

    itens.forEach(e=>{

        if(e.querySelector('.tamanho_item').innerHTML != a.value){
            e.querySelector('.tamanho_item').parentElement.parentElement.parentElement.style.display='none'
        }
